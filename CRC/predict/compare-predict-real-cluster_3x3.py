...
output_file=base_path+'heatmap_3x3/predict-real-by-cluster_3x3'
output_statistics_file=base_path+'heatmap_3x3/statistics-by-cluster_3x3'     #statistics results
