...
def train_models_subs(train_path,extra_path,val_path,test_path,batch_size,file_path):
    ...
    callback_1 = ActivationLogger(0.9,True)   #0.9, 0.95,0.99
...
first_epoches = 80 #80,150  pretrain and don't save model
decay_rate = 0.99
learning_rate = 1e-4
validation_steps = 10 #10-100
path='/media/disk3/pcam-semi-up/subs-pcam-0.05' #ssubs-pcam-0.1(0.1 training set)，subs-pcam-no-extra(all traning data)
model_path='Model-0.05-SSL'
fw=open('subs-pcam-0.05-SSL.txt','a')
